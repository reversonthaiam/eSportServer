...
INSERT INTO "new_Ad" ("createAt", "discord", "gameId", "hourEnd", "id", "name", "useVoiceChannel", "weekDays", "yearsPlaying") SELECT "createAt", "discord", "gameId", "hourEnd", "id", "name", "useVoiceChannel", "weekDays", "yearsPlaying" FROM "Ad";
DROP TABLE "Ad";
